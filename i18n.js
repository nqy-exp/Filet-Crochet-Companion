...
const i18nData = {
    'zh-CN': {
        ...
        'hint_smart_threshold': '(0=极度敏感/全黑 | 255=不敏感/全白 | 推荐值: 100~160 ｜ 必须输入整数)',
...
'btn_confirm_close': '确认退出',
    ...
    'en-US': {
        ...
        'hint_smart_threshold': '(0=Very sensitive/Black | 255=Insensitive/White | Rec: 100-160 | Integers only)',
...
'btn_confirm_close': 'Confirm Close', 
        ...
        'hint_smart_threshold': '(0=Sehr sensibel/Schwarz | 255=Unempfindlich/Weiß | Empf.: 100-160 | Nur Ganzzahlen)',
...
'btn_confirm_close': 'Schließen bestätigen',
    ...
    'fr-FR': {
        ...
        'hint_smart_threshold': '(0=Très sensible/Noir | 255=Insensible/Blanc | Rec: 100-160 | Entier uniquement)',
...
'btn_confirm_close': 'Confirmer la fermeture',
    ...
    'es-ES': {
        ...
        'hint_smart_threshold': '(0=Muy sensible/Negro | 255=Insensible/Blanco | Rec: 100-160 | Solo enteros)',
...
'btn_confirm_close': 'Confirmar cierre',
    ...
    'ru-RU': {
        ...
        'hint_smart_threshold': '(0=Очень чувств./Черный | 255=Нечувств./Белый | Реком.: 100-160 | Только целые)',
...
'btn_confirm_close': 'Подтвердить закрытие',
    ...
    'ja-JP': {
        ...
        'hint_smart_threshold': '(0=非常に敏感/黒 | 255=不感度/白 | 推奨: 100~160 | 整数のみ入力)',
...
'btn_confirm_close': '閉じるを確認',
        ...
        'hint_smart_threshold': '(0=極度敏感/全黑 | 255=不敏感/全白 | 推薦值: 100~160 ｜ 必須輸入整數)',
